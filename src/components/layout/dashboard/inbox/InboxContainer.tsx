...
export const InboxContainer = () => {
  ...
  return (
    <div className="w-full h-[calc(100vh-(--spacing(32)))] bg-white rounded-2xl border border-gray-100 shadow-xl shadow-gray-100/50 flex overflow-hidden animate-in fade-in duration-500">
      <ChatSidebar
        chats={filteredChats}
