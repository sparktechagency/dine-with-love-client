  ...
  return (
    <Card className="rounded-md border border-gray-100 shadow-sm p-8 transition-all hover:border-gray-200">
      ...
      <CardContent className="px-0 pb-0">
        <div className="rounded-md border border-gray-100 p-8 space-y-6">
          ...
          <div className="flex justify-start">
            <Button className="h-10 px-8 bg-linear-to-r from-[#FF3AB3] to-[#5432C8] text-white rounded-md font-bold text-xs shadow-none transition-all hover:scale-[1.02] active:scale-[0.98]">
              Delete account
            </Button>
          </div>
        </div>
