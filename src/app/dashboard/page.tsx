...
export default function DashboardPage() {
  const stats = [
    { title: "Reservations", value: "12", change: "+2 from last week", icon: Calendar },
    { title: "Reviews", value: "8", change: "+1 from last week", icon: Star },
    { title: "Favorites", value: "24", change: "+3 from last week", icon: Heart },
    { title: "Points", value: "1,250", change: "+150 from last week", icon: TrendingUp },
  ];
                ...
                {recentReservations.map((reservation) => (
                  <div key={reservation.id} className="flex items-center space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium truncate">{reservation.restaurant}</p>
