...
export default function MatchingAdvisorPage() {
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="space-y-4">
              <div className="grid gap-2">
                ...
                {/* Simplified for now, could be a date picker */}
                <Input id="preferenceDate" placeholder="Select dates" />
              </div>
              ...
              <div className="space-y-2">
                ...
                >
                  <div className="relative">
                    ...
                    <Label
                      htmlFor="1:1"
                      className="flex flex-col items-center justify-between rounded-md border-2 border-muted bg-popover p-4 hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-[#D946EF] [&:has([data-state=checked])]:border-[#D946EF]"
                    >
            ...
            <div className="flex justify-end">
              <Button
                type="submit"
                className="bg-linear-to-r from-[#FF3AB3] to-[#5432C8] text-white"
              >
                Submit to advisor
              </Button>
            </div>
