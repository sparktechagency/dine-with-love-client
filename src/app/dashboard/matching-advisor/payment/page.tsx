...
export default function MatchingAdvisorPaymentPage() {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div className="rounded-lg border bg-card text-card-foreground shadow-xs p-6">
            ...
            <Button className="w-full mt-6 bg-linear-to-r from-[#FF3AB3] to-[#5432C8] text-white">
              Pay
            </Button>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  ...
                  <Input id="expiry" placeholder="Month / Year" />
                </div>
                <div className="grid gap-2">
            ...
            <CardFooter className="flex justify-between gap-4">
              ...
              <Button className="w-full bg-linear-to-r from-[#FF3AB3] to-[#5432C8] text-white">
                Pay
              </Button>
            </CardFooter>
          </Card>
