        ...
        <div className="container mx-auto px-4 py-4">
          <nav className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-bold">DineWithLove</h1>
            </div>
            <div className="flex items-center space-x-4">
      ...
      <footer className="border-t mt-auto">
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="font-semibold mb-4">DineWithLove</h3>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="#" className="text-muted-foreground hover:text-foreground">License</a></li>
              </ul>
            </div>
          </div>
          <div className="mt-8 pt-8 border-t text-center text-sm text-muted-foreground">
            © 2024 DineWithLove. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
